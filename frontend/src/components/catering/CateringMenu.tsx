...
const menuCategories = [
    ...
    },
    {
        ...
        icon: CakeSlice,
        description:
            "An indulgent selection of artfully crafted desserts—ranging from multi-layered signature cakes and bespoke crepe creations to elegant cheesecakes, rustic galettes, and timeless classics reimagined.",
        subCategories: [
            {
                id: "mini-desserts",
                name: "Mini Desserts",
                ...
                items: [
                    {
                        ...
                        description:
                            "Custom multi-layer cakes in flavors like Red Velvet, Carrot, Banana, Coffee, and Lemon, with fillings including vanilla bean custard, fruit compotes, chocolate, mousse, and more.",
                        price: ""
                    },
                    {
                        name: "Tailored Layer Cake",
                        description:
                            "Your bespoke layered cake — crafted to your flavor preferences. Inquire for our curated selections.",
                        price: ""
                    },
                    {
                        name: "12-Layer Chocolate Cake",
                        description:
                            "Decadent chocolate cake with alternating layers of ganache and cocoa cream.",
                        price: ""
                    },
                    {
                        name: "Strawberry & Cream Cake",
                        description:
                            "Vanilla sponge with strawberry compote, whipped cream, and custard.",
                        price: ""
                    },
                    {
                        name: "Banana Toffee Crunch Cake",
                        description:
                            "Banana sponge with toffee filling, caramel cream, and praline crunch.",
                        price: ""
                    },
                    {
                        name: "Birthday Cake Funfetti",
                        description:
                            "Classic vanilla with sprinkles, cream cheese or marshmallow frosting.",
                        price: ""
                    },
                    {
                        name: "Coconut Lotus Chocolate Cake",
                        description:
                            "Rich chocolate with coconut shavings and Lotus spread frosting.",
                        price: ""
                    },
                    {
                        name: "Olive Oil Lemon Basil Cake",
                        description:
                            "Fragrant olive oil sponge with lemon curd and basil cream.",
                        price: ""
                    }
                ]
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        description:
                            "Layers of custard-filled crêpes topped with caramelized sugar.",
                        price: ""
                    },
                    {
                        name: "Milk Tea Crêpe Cake",
                        description:
                            "Crêpes layered with milk tea pastry cream, a boba-inspired favorite.",
                        price: ""
                    },
                    {
                        name: "Chocolate Mocha Crêpe Cake",
                        description:
                            "Chocolate and coffee crêpes stacked with mocha ganache.",
                        price: ""
                    }
                ]
            },
                ...
                items: [
                    {
                        ...
                        description:
                            "Silky baked cheesecake with optional fruit or chocolate toppings.",
                        price: ""
                    },
                    {
                        name: "No-Bake Cheesecake",
                        description:
                            "Light and creamy mousse-style cheesecake with seasonal fruit compote.",
                        price: ""
                    },
                    {
                        name: "Burnt Basque Cheesecake",
                        description:
                            "Custardy cheesecake with a caramelized top, served plain or with toppings.",
                        price: ""
                    }
                ]
            },
                ...
                items: [
                    {
                        ...
                        description:
                            "Free-form tart with options like cinnamon apples, grilled peaches with burrata, or stone fruits.",
                        price: ""
                    },
                    {
                        name: "Berry Cobbler",
                        description:
                            "Mixed seasonal berries baked with vanilla biscuit topping.",
                        price: ""
                    },
                    {
                        name: "Pecan Pie",
                        description:
                            "Toasted pecans in a rich brown sugar custard with flaky pie crust.",
                        price: ""
                    },
                    {
                        name: "Pumpkin Pie",
                        description:
                            "Pumpkin in a rich butternut custard with flaky pie crust.",
                        price: ""
                    },
                    {
                        name: "Chocolate Cream Pie",
                        description:
                            "Rich chocolate custard in a flaky pie crust with whipped cream and chocolate shavings",
                        price: ""
                    },
                    {
                        name: "Key Lime Pie",
                        description:
                            "Tart and creamy key lime custard in a graham cracker crust with whipped cream",
                        price: ""
                    }
                ]
            },
                ...
                items: [
                    {
                        ...
                        description:
                            "A refined interpretation of the Italian classic — crafted with espresso-soaked ladyfingers, whipped mascarpone, and a dusting of cocoa. Custom flavors available upon request.",
                        price: ""
                    },
                    {
                        name: "Chocolate Mousse",
                        description:
                            "Light and creamy mousse with chocolate shavings",
                        price: ""
                    },
                    {
                        name: "Butterscotch Bread Pudding",
                        description:
                            "With Creme anglaise, candied pecans, and cardamon mousse",
                        price: ""
                    }
                ]
            }
