...
const UmamiCellar = () => {
    ...
    const defaultTabValue = cellarData.length > 0 ? cellarData[3].id : "";
        ...
        <section className="py-16 bg-background">
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto">
                    {cellarData.length > 0 ? <Tabs defaultValue={defaultTabValue} className="w-full">
                            ...
                            {cellarData.map(category => <TabsContent key={category.id} value={category.id} className="space-y-8">
                                    <div>
                        ...
                        </Tabs> : <div className="text-center py-20">No cellar items found.</div>}
